...
class GlobalPooling(nn.Module):
    """
    Global Average Pooling (Standard ASPP branch)
    """
...
class ASPP(nn.Module):
    def __init__(self, in_channels, atrous_rates, out_channels=256):
        ...
        # Global Pooling (Replacing Strip Pooling)
        modules.append(GlobalPooling(in_channels, out_channels))
...
class DecoderBlock(nn.Module):
    def __init__(self, in_channels, skip_channels, out_channels):
        ...
        self.skip_smooth = SmoothBlock(skip_channels, 48)  # Using Standard SmoothBlock
