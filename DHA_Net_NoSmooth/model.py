...
class DecoderBlock(nn.Module):
    def __init__(self, in_channels, skip_channels, out_channels):
        ...
        # Simple Skip Connection (No Smooth/Strip) - Just reduce channels
        self.skip_smooth = nn.Sequential(nn.Conv2d(skip_channels, 48, 1, bias=False), nn.BatchNorm2d(48), nn.ReLU(inplace=True))
