...
class Model(nn.Module):
    ...
    def __init__(self, in_channels=3, num_classes=1):
        ...
        if in_channels != 3:
             self.encoder1.conv1 = nn.Conv2d(in_channels, 64, kernel_size=7, stride=2, padding=3, bias=False)
             self.encoder2.conv1 = nn.Conv2d(in_channels, 64, kernel_size=7, stride=2, padding=3, bias=False)
